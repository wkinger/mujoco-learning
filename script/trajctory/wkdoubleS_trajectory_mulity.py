...
if __name__ == "__main__":
    ...
    # constrains = np.array(([0,10,3,-2,  20,-20,100,-100,100,-100],
    #                         [0,10,1,0,  20,-20,100,-100,100,-100],
    #                         [0,13,1,0,  20,-20,100,-100,100,-100],
    #                         [30,10,1,0, 20,-20,100,-100,100,-100],
    #                         [-10,10,1,0,20,-20,100,-100,100,-100],
    #                         [0,11,1,0,  20,-20,100,-100,100,-100],
    #                         [2,10,1,0,  20,-20,100,-100,100,-100]
    #                      ), dtype=float)
    # start = np.array([0.087233, 0.085969, 0.087275, 0.087383, 0.087227, 0.087263, 0.087203])
    # command = np.array([14.998000, 24.923000, 35.000000, 45.007000, 54.998000, 65.000000, 74.997000])
    # constrains[:,0] = start
